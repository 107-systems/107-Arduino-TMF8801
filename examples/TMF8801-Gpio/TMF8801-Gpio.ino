/**
 * @brief example demonstrating gpio usage of 107-Arduino-TMF8801 library.
 */
...
static uint8_t const MEASUREMENT_PERIOD_ms = 0;
...
void loop()
{
  tmf8801.set_gpio(TMF8801::GPIO::GPIO0);
  delay(300);
  tmf8801.set_gpio(TMF8801::GPIO::GPIO1);
  delay(300);
  tmf8801.clr_gpio(TMF8801::GPIO::GPIO0);
  delay(300);
  tmf8801.clr_gpio(TMF8801::GPIO::GPIO1);
  delay(300);
}
